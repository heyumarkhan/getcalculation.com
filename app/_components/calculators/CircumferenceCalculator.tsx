...
export default function CircumferenceCalculator({ 
  ...
  const calculateCircumference = () => {
    ...
    if (inputType === 'radius') {
      ...
      steps.push(`C = 2 × ${(Math.PI * radius).toFixed(6)}`);
      steps.push(`C = ${circumference.toFixed(6)} units`);
    } else {
      circumference = Math.PI * value;
      steps.push(`Circumference (C) = π × d`);
      steps.push(`C = π × ${value}`);
      steps.push(`C = ${circumference.toFixed(6)} units`);
    }
        ...
        <div className="space-y-6">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Using Radius:</strong> C = 2πr</p>
              <p><strong>Using Diameter:</strong> C = πd</p>
              <p><strong>Where:</strong> π ≈ 3.14159</p>
              <p><strong>Relationship:</strong> d = 2r (diameter is twice the radius)</p>
            </div>
          </div>
        </div>
      </Card>
