  ...
  return (
    <Card className="p-6">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Wire Size Calculator</h2>
        <p className="text-gray-600">Calculate wire gauge (AWG), current capacity, or voltage drop for electrical wiring</p>
      </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            {calculationMode === 'wireSize' && (
              <>
                <li>• Enter current, supply voltage, maximum voltage drop, and wire length</li>
            ...
            {calculationMode === 'current' && (
              <>
                <li>• Enter wire gauge (AWG), supply voltage, maximum voltage drop, and length</li>
            ...
            {calculationMode === 'voltageDrop' && (
              <>
                <li>• Enter wire gauge (AWG), current, supply voltage, and length</li>
