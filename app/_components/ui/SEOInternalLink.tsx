...
export const INTERNAL_LINKS = {
  ...
  triangleHeight: { href: '/math/triangle-height', title: 'Height of a Triangle Calculator' },
  'triangle-height': { href: '/math/triangle-height', title: 'Height of a Triangle Calculator' },
  surfaceArea: { href: '/math/surface-area', title: 'Surface Area Calculator' },
  'surface-area': { href: '/math/surface-area', title: 'Surface Area Calculator' },
