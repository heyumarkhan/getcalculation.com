...
export default function Button({ 
  ...
  const variantClasses = {
    primary: 'bg-[#820ECC] text-white hover:bg-[#6B0BA8] focus:ring-[#820ECC]',
    secondary: 'bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500',
    outline: 'border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-[#820ECC]',
