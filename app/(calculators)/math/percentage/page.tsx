  ...
  return (
    ...
    >
      ...
      <SEOSection title="Conclusion">
        ...
        <p>
           Explore more math tools: Check out our {createInternalLink('math/percentage-change')} to track growth and variations, or the essential {createInternalLink('math/average')} for analyzing groups of numbers.
        </p>
      </SEOSection>
    </CalculatorPageTemplate>
  );
